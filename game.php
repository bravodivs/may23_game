...
function start()
{
    ...
    $dice = $_POST['player1']; // Retrieve input value from the form
    ...
    $dice = $_POST['player2']; // Retrieve input value from the form
...
// : write the logic to intiate positions each time button is clicked
